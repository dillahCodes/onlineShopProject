...
import PhotoCommnentsSlider from "../../components/ui/photo-comment-slider";
      ...
      <div className="flex flex-col w-full mt-10 h-fit">
        ...
        <div className="flex items-center justify-between w-full">
          <div className="flex flex-col gap-y-2">
            <h1 className="text-base font-bold capitalize font-space-grotesk">ulasan pilihan</h1>
  ...
  return (
    <div className="w-full h-[300px] flex flex-col  mt-5">
      ...
      <div className="flex items-center justify-center w-full font-medium gap-x-2 font-space-grotesk">
        <span>{currentProductData?.review.filter((review) => review.rating).length} rating</span>
        <span>•</span>
        <span>{currentProductData?.review.filter((review) => review.comment).length} ulasan</span>
      </div>
      {/* rating chart */}
