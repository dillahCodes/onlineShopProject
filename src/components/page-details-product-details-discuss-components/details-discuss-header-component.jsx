...
const DetailsDiscussHeaderComponent = ({ discussUserID, productOwnerId, created_at, discus_message, discussUserName, avatar }) => {
  return (
    <>
      <div className="w-full flex items-center gap-x-2 p-3 pb-2">
        <div className="w-6 h-6 border border-black rounded-full overflow-hidden">
          <img src={avatar === "default_avatar.png" ? "/default_avatar.png" : avatar} alt="" />
        </div>
      ...
      <section className="w-full px-3 border-b">
        ...
        <ButtonComponent className={"capitalize my-5 font-bold border-[#00AA5B] text-[#00AA5B] rounded-xl py-0.5 px-8 flex items-center justify-center"}>follow</ButtonComponent>
